...
# The hand-placed cuts are the ONLY training signal here and cannot be regenerated by machine
# (auto cuts measure worse — see CHANGELOG M16). They lived in ~/Downloads, which is the folder
# people periodically empty; they were nearly lost that way. Keep them in the repo so they are
# version-controlled and backed up. Override with LABEL_BOXES_DIR (same var portal.py honours).
_REPO_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
FOLDER = os.environ.get("LABEL_BOXES_DIR") or os.path.join(_REPO_ROOT, "label_boxes")
